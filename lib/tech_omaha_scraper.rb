...
module TechOmahaScraper
  ...
  def self.scrape
    ...
    url2  = "https://www.google.com/calendar/htmlembed?height=600&wkst=1&bgcolor=%23ff6666&src=689bo9l4k74mu9unjbqtnulpn0@group.calendar.google.com&color=%23A32929&ctz=America/Chicago&dates=2014#{this_month + 1}01/2014#{TechOmahaScraper.next_month(this_month + 1)}01&mode=MONTH"
    page  = agent.get(url)
